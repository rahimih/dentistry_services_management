...
{
    public partial class reporting13_view : Form
    {
       ...
       public string ipadress;
        ...
        private void reporting13_view_Load(object sender, EventArgs e)
        {
            ...
            cryRpt.Load(Application.StartupPath + @"\referrals_Count_CrystalReport1.rpt");
