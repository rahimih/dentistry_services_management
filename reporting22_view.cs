...
{
    public partial class reporting22_view : Form
    {
        public string fromdate;
        public string todate;
       public string ipadress;
        public reporting22_view()
        {
            InitializeComponent();
        }
        ...
        private void reporting22_view_Load(object sender, EventArgs e)
        {
            ...
            cryRpt.Load(Application.StartupPath + @"\countscreen.rpt");
