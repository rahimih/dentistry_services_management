...
{
    public partial class reporting5_view : Form
    {
       public string fromdate;
       public string todate;
       public int doctorscode;
       public string ipadress;
        public reporting5_view()
        {
            InitializeComponent();
        }
        ...
        private void reporting5_view_Load(object sender, EventArgs e)
        {
            ...
            cryRpt.Load(Application.StartupPath + @"\Doctorsworktime_Datail_CrystalReport1.rpt");
