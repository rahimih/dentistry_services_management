...
{
    public partial class Report_health_2_F : Form
    {
        public string fromdate;
        public string todate;
        public string ipadress;
        public Report_health_2_F()
        {
            InitializeComponent();
        }
        ...
        private void Report_health_2_F_Load(object sender, EventArgs e)
        {
            ...
            cryRpt.Load(Application.StartupPath + @"\Report1_health_2.rpt");
