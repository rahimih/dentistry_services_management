...
{
    public partial class reporting7_view : Form
    {
       public string fromdate;
       public string todate;
       public int doctorscode;
       public string ipadress;
        public reporting7_view()
        {
            InitializeComponent();
        }
        ...
        private void reporting7_view_Load(object sender, EventArgs e)
        {
            ...
            cryRpt.Load(Application.StartupPath + @"\Form_f16-2_CrystalReport1.rpt");
