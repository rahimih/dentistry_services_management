...
{
    public partial class reporting10_view : Form
    {
       ...
       public string ipadress;
        ...
        private void reporting10_view_Load(object sender, EventArgs e)
        {
            ...
            cryRpt.Load(Application.StartupPath + @"\joblocations_count_CrystalReport1.rpt");
