...
{
    public partial class reporting33_view : Form
    {
       public string fromdate;
       public string todate;
       public int doctorscode,groupcode;
       public int zarib;
       public string ipadress;
        public reporting33_view()
        {
            InitializeComponent();
        }
        ...
        private void reporting3_view_Load(object sender, EventArgs e)
        {
            ...
            cryRpt.Load(Application.StartupPath + @"\Doctorsworkwithservicesgroupcode_CrystalReport1.rpt");
            ...
            crParameterDiscreteValue.Value = groupcode;
            crParameterFieldDefinitions = cryRpt.DataDefinition.ParameterFields;
            crParameterFieldDefinition = crParameterFieldDefinitions["@groupcode"];
            crParameterValues = crParameterFieldDefinition.CurrentValues;
            crParameterValues.Add(crParameterDiscreteValue);
            crParameterFieldDefinition.ApplyCurrentValues(crParameterValues);
            ...
            crParameterDiscreteValue.Value = groupcode;
            crParameterFieldDefinitions = cryRpt.DataDefinition.ParameterFields;
            crParameterFieldDefinition = crParameterFieldDefinitions["@Services_group_Code"];
            crParameterValues = crParameterFieldDefinition.CurrentValues;
            crParameterValues.Add(crParameterDiscreteValue);
            crParameterFieldDefinition.ApplyCurrentValues(crParameterValues);
