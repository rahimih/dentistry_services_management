...
{
    public partial class reporting9_view : Form
    {
       public string fromdate;
       public string todate;
       public int doctorscode;
       public string ipadress;
        public reporting9_view()
        {
            InitializeComponent();
        }
        ...
        private void reporting9_view_Load(object sender, EventArgs e)
        {
            ...
            cryRpt.Load(Application.StartupPath + @"\Kanal_Count_CrystalReport1.rpt");
