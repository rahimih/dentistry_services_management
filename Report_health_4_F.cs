...
{
    public partial class Report_health_4_F : Form
    {
        public string fromdate;
        public string todate, ipadress;
        public int fromage, endage;
        public Report_health_4_F()
        {
            InitializeComponent();
        }
        ...
        private void Report_health_4_F_Load(object sender, EventArgs e)
        {
            ...
            cryRpt.Load(Application.StartupPath + @"\Report1_health_4.rpt");
            ...
            crParameterDiscreteValue.Value = endage;
            crParameterFieldDefinitions = cryRpt.DataDefinition.ParameterFields;
            crParameterFieldDefinition = crParameterFieldDefinitions["@endage"];
            crParameterValues = crParameterFieldDefinition.CurrentValues;
            crParameterValues.Add(crParameterDiscreteValue);
            crParameterFieldDefinition.ApplyCurrentValues(crParameterValues);
