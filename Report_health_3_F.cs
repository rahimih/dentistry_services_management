...
{
    public partial class Report_health_3_F : Form
    {
        public string fromdate;
        public string todate,ipadress;
        public Report_health_3_F()
        {
            InitializeComponent();
        }
        ...
        private void Report_health_3_F_Load(object sender, EventArgs e)
        {
            ...
            cryRpt.Load(Application.StartupPath + @"\Report1_health3.rpt");
