...
{
    public partial class reporting24_view : Form
    {
        public string fromdate;
        public string todate;
        public string ipadress;
        public reporting24_view()
        {
            InitializeComponent();
        }
        ...
        private void reporting24_view_Load(object sender, EventArgs e)
        {
            ...
            cryRpt.Load(Application.StartupPath + @"\max_refer23.rpt");
