...
{
    public partial class reporting11_view : Form
    {
       public string fromdate;
       public string todate;
       public int pk_company;
       public int pk_managment;
       public int zarib;
       public string ipadress;
        public reporting11_view()
        {
            InitializeComponent();
        }
        ...
        private void reporting11_view_Load(object sender, EventArgs e)
        {
            ...
            cryRpt.Load(Application.StartupPath + @"\paientwithjoblocations_CrystalReport1.rpt");
            ...
            crParameterDiscreteValue.Value = pk_company ;
            crParameterFieldDefinitions = cryRpt.DataDefinition.ParameterFields;
            ...
            crParameterDiscreteValue.Value = pk_managment;
            crParameterFieldDefinitions = cryRpt.DataDefinition.ParameterFields;
