...
{
    public partial class reporting16_view : Form
    {
       ...
       public string ipadress;
        ...
        private void reporting16_view_Load(object sender, EventArgs e)
        {
            ...
            cryRpt.Load(Application.StartupPath + @"\introduction_outcenterdepartment_CrystalReport1.rpt");
