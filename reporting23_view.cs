...
{
    public partial class reporting23_view : Form
    {
        public string fromdate;
        public string todate;
       public string ipadress;
       public int zarib;
        public reporting23_view()
        {
            InitializeComponent();
        }
        ...
        private void reporting23_view_Load(object sender, EventArgs e)
        {
            ...
            cryRpt.Load(Application.StartupPath + @"\countK.rpt");
