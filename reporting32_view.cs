...
{
    public partial class reporting32_view : Form
    {
       public string fromdate;
       public string todate;
       public int turnstatus;
       public string ipadress;
       public reporting32_view()
        {
            InitializeComponent();
        }
        ...
        private void reporting17_view_Load(object sender, EventArgs e)
        {
            ...
            cryRpt.Load(Application.StartupPath + @"\selectPaientList_turnstatus_gh_CrystalReport1.rpt");
