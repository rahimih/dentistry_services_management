...
{
    public partial class reporting19_view : Form
    {
       ...
       public string ipadress;
        ...
        private void reporting19_view_Load(object sender, EventArgs e)
        {
            ...
            cryRpt.Load(Application.StartupPath + @"\Doctorsworkwithpaientstatus_CrystalReport1.rpt");
            ...
            crParameterDiscreteValue.Value = paienttype;
            crParameterFieldDefinitions = cryRpt.DataDefinition.ParameterFields;
            crParameterFieldDefinition = crParameterFieldDefinitions["@PaientstatusCodeName"];
            crParameterValues = crParameterFieldDefinition.CurrentValues;
            crParameterValues.Add(crParameterDiscreteValue);
            crParameterFieldDefinition.ApplyCurrentValues(crParameterValues);
