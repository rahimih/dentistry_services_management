...
{
    public partial class reporting8_view : Form
    {
       public string fromdate;
       public string todate;
       public int doctorscode;
       public string ipadress;
        public reporting8_view()
        {
            InitializeComponent();
        }
        ...
        private void reporting8_view_Load(object sender, EventArgs e)
        {
            ...
            cryRpt.Load(Application.StartupPath + @"\Count_pin_CrystalReport1.rpt");
