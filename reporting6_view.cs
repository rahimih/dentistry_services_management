...
{
    public partial class reporting6_view : Form
    {
       public string fromdate;
       public string todate;
       public int doctorscode;
       public string ipadress;
        public reporting6_view()
        {
            InitializeComponent();
        }
        ...
        private void reporting6_view_Load(object sender, EventArgs e)
        {
            ...
            cryRpt.Load(Application.StartupPath + @"\Form_f16_CrystalReport1.rpt");
